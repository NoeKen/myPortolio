...
export function Projects() {
  const projects: Project[] = [
    {
      ...
      description:
        "Une application mobile permettant aux équipes de gérer le suivi des demandes de congés au sein de l'entreprise.",
      image:
    ...
    },
    {
      ...
      description:
        "Application de gestion des dépenses financières pour une meilleure visibilité sur les finances personnelles.",
      image:
      ...
      liveUrl:
        "https://play.google.com/store/apps/details?id=com.beaware&pcampaignid=web_share",
      category: "development",
    },
    // {
    //   id: 3,
  ...
  return (
    <section id="projects" className="py-16 md:py-24 bg-accent/20">
      ...
      .map((project, i) => (
        // ... exact same card rendering here
        // tu peux copier-coller le bloc ci-dessus
      ))} */}
            </div>
          </div>
